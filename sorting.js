...
const stringsToNumbers = (numbers) => {
  ...
  const idealTemp =
       ...
       * methods()
       *   -map()
       *        ~array.prototype.map(): returns a new array populated with the results of calling a provided function on every element in the calling array. 
       *        
       * 
       */
...
- [ ] Get into the practice of working with branches by creating a new branch called "sorting-branch".
        - check configuration git remote -v
