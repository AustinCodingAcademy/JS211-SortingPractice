  ...
  const stringsToNumbs = (numbers) => {
      let digits = numbers.map(Number);
      return digits;
  }
  console.log("#1 array of digits - return string to numbers: ");
  ...
  const sumEvens = () => {
      let evenDigits = nums.filter(num => num % 2 === 0);
      let evenSum = evenDigits.reduce((total, num) => total + num);
      return evenSum;
  }

  console.log("#2 find the sum of even: ");
  ...
  console.log("#3 find the index and value: ");
  ...
  console.log("#4 array of weather_state_name: ");
  ...
  console.log("#5 find the id of the object in weather-15.915: ");
