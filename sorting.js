...
let newArray = stringsToNumbs(strNums);
...
//    const atxIdx = (nums) => {
//   let found = nums.find((element, index) => {
//     element+index == 512;
...
// atxIdx(newArray);
  ...
  const weatherStates = function(){
    let map1 = weather.map(x => x.weather_state_name)
      console.log(map1)
    }
  ...
  const idealTemp = function(){
    let map2 = weather.find(y => y.min_temp = 15.915)
    console.log(map2)
  }
 idealTemp();
